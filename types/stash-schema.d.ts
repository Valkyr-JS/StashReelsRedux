...
/** Renamed from `Plugin` to `StashPlugin` to avoid conflicts with third-party
 * libs. */
type StashPlugin = {
  __typename?: "Plugin";
  description?: Maybe<Scalars["String"]["output"]>;
...
type Query = {
  ...
  /** List loaded plugins */
  plugins?: Maybe<Array<StashPlugin>>;
